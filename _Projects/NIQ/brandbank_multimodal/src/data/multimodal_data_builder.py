...
class MultimodalDataBuilderConfig(BuilderConfig):
    def __init__(self, **kwargs):
        super(MultimodalDataBuilderConfig, self).__init__(**kwargs)


class MultimodalDataBuilder(GeneratorBasedBuilder):
