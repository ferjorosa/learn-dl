...
from run_multimodal_experiment import train_and_test_model
...
def main():
    ...
    experiment_configs = [
        ...
        # "./config/brandbank_5000_examples_10_groups/flava_multimodal_encoder.yaml",
        # # 20000 descriptions, 10 classes
        # "./config/brandbank_20000_examples_10_groups/flava_multimodal_encoder.yaml",
        # # 50000 descriptions, 100 classes
        # "./config/brandbank_50000_examples_100_groups/flava_multimodal_encoder.yaml",
        # 262000 descriptions, 260 classes
        "./config/brandbank_all_examples_all_groups/flava_multimodal_encoder.yaml",
    ]
