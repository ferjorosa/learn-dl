...
# Self-attention heads usually have smaller dimension than embeddings)
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, embed_dim, head_dim, block_size):
        ...
        )  # multiplied by num_heads because we concatenate the head results
        self.dropout = nn.Dropout(dropout)
...
model = BigramLanguageModel(
    vocab_size, block_size, embed_dim, attention_dim, num_attention_heads, num_blocks
)
m = model.to(device)
